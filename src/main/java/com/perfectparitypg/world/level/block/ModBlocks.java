...
public class ModBlocks {
    ...
    static {
        ...
        PALE_OAK_WALL_SIGN = register("pale_oak_wall_sign", new TerraformWallSignBlock(PALE_OAK_SIGN_TEXTURE, BlockBehaviour.Properties.of().mapColor(PALE_OAK_PLANKS.defaultMapColor()).forceSolidOn().instrument(NoteBlockInstrument.BASS).noCollission().strength(1.0F).ignitedByLava()), true);
